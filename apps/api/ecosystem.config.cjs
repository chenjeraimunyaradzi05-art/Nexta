...
module.exports = {
  ...
  deploy: {
    production: {
      user: 'deploy',
      host: ['server1.nexta.com.au', 'server2.nexta.com.au'],
      ref: 'origin/main',
      repo: 'git@github.com:nexta/api.git',
      path: '/var/www/nexta-api',
    ...
    staging: {
      user: 'deploy',
      host: 'staging.nexta.com.au',
      ref: 'origin/develop',
      repo: 'git@github.com:nexta/api.git',
      path: '/var/www/nexta-api-staging',
