...
const DEFAULT_TEMPLATES = {
  welcome: {
    name: 'Welcome Email',
    subject: 'Welcome to Nexta, {{firstName}}!',
    category: 'onboarding',
...
<body style="margin:0;padding:0;background:#0f172a;font-family:system-ui,-apple-system,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#1e293b;border-radius:16px;overflow:hidden;">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#1a0f2e,#2d1b69);padding:32px;text-align:center;">
              <h1 style="margin:0;color:#ffd700;font-size:28px;">Nexta</h1>
            </td>
          </tr>
          <!-- Content -->
          <tr>
            <td style="padding:40px 32px;">
              ...
              <p style="margin:0 0 24px;color:#94a3b8;font-size:16px;line-height:1.6;">
                Thank you for joining Nexta. We're excited to have you on board.
              </p>
              <p style="margin:0 0 24px;color:#94a3b8;font-size:16px;line-height:1.6;">
          ...
          <tr>
            <td style="padding:24px 32px;border-top:1px solid #334155;text-align:center;">
              <p style="margin:0;color:#64748b;font-size:12px;">
                © 2026 Nexta. All rights reserved.
              </p>
            </td>
          </tr>
        </table>
    ...
    textTemplate: `Welcome to Nexta, {{firstName}}!
...
© 2026 Nexta`,
  ...
  passwordReset: {
    name: 'Password Reset',
    subject: 'Reset your Nexta password',
    category: 'security',
...
router.post('/:slug/preview', authenticate, authorize(['ADMIN']), async (req, res) => {
  try {
    ...
    const data = sampleData || {
      ...
      loginUrl: 'https://nexta.example/login',
      resetUrl: 'https://nexta.example/reset?token=xxx',
      updatePaymentUrl: 'https://nexta.example/billing',
      dashboardUrl: 'https://nexta.example/dashboard',
