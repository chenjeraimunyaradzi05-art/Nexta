...
export function paymentFailedTemplate(params) {
  ...
  <div style="font-family: system-ui, -apple-system, 'Segoe UI', Roboto, Arial; color:#111; max-width:600px; margin:0 auto;">
    ...
    <p style="margin:0; color:#777; font-size: 12px;">
      If you have questions, contact us at support@nexta.example<br/>
  ...
  <div style="font-family: system-ui, -apple-system, 'Segoe UI', Roboto, Arial; color:#111; max-width:600px; margin:0 auto;">
    ...
    <div style="background: #f9fafb; padding: 16px; text-align: center; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
      <p style="margin:0; color:#9ca3af; font-size: 12px;">
        © ${new Date().getFullYear()} Nexta. Supporting First Nations futures.
      </p>
    </div>
  </div>
  `;
...
export function contactConfirmationTemplate(params: any) {
  ...
  <div style="font-family: system-ui, -apple-system, 'Segoe UI', Roboto, Arial; color:#111; max-width:600px; margin:0 auto;">
    ...
    <div style="background: #fff; padding: 32px; border: 1px solid #e5e7eb; border-top: none;">
      ...
      <p style="margin:0; color: #6b7280; font-size: 14px;">
        Need urgent help? Check our <a href="${params.baseUrl || 'https://nexta.com.au'}/help" style="color: #6B4C9A;">Help Center</a>.
      </p>
    </div>
...
export function advertisingConfirmationTemplate(params) {
  ...
  <div style="font-family: system-ui, -apple-system, 'Segoe UI', Roboto, Arial; color:#111; max-width:600px; margin:0 auto;">
    ...
    <div style="background: #fff; padding: 32px; border: 1px solid #e5e7eb; border-top: none;">
      ...
      <p style="margin:0; color: #6b7280; font-size: 14px;">
        Questions? Reply to this email or contact partnerships@nexta.com.au
      </p>
    </div>
...
function welcomeTemplate(params) {
    const subject = `Welcome to Nexta, ${params.name}!`;
    const text = `Welcome to Nexta, ${params.name}!\n\nYour account has been created successfully. You can now:\n- Browse and apply for jobs\n- Connect with mentors\n- Access training courses\n- Join our community\n\nGet started: ${params.dashboardUrl || 'https://nexta.com.au/dashboard'}\n\n— The Nexta Team`;
    const html = `
  <div style="font-family: system-ui, -apple-system, 'Segoe UI', Roboto, Arial; color:#111; max-width:600px; margin:0 auto;">
    <div style="background: linear-gradient(135deg, #1A0F2E, #2D1B69); padding: 32px; text-align: center; border-radius: 8px 8px 0 0;">
      <h1 style="margin:0 0 8px 0; color: #FFD700; font-size: 28px;">Welcome to Nexta</h1>
    ...
    <div style="background: #fff; padding: 32px; border: 1px solid #e5e7eb; border-top: none;">
      ...
      <p style="margin:0 0 24px 0; color: #374151;">
        Your Nexta account is ready. We're excited to support you on your career journey.
      </p>
      ...
      <div style="text-align: center; margin: 32px 0;">
        <a href="${params.dashboardUrl || 'https://nexta.com.au/dashboard'}"
           style="display: inline-block; background: linear-gradient(135deg, #6B4C9A, #3D1A2A); color: #FFD700; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600;">
          Go to Dashboard
        </a>
      </div>
      ...
      <p style="margin:0; color: #6b7280; font-size: 14px; text-align: center;">
        Need help? Check out our <a href="${params.baseUrl || 'https://nexta.com.au'}/help" style="color: #6B4C9A;">Help Center</a> or reply to this email.
      </p>
    </div>
...
function weeklyDigestTemplate(params) {
    const subject = `Your weekly update from Nexta`;
