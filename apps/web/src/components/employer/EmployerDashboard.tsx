      ...
      <div className="flex items-start justify-between">
        ...
        <div className="text-right">
          <div className="flex items-center gap-1">
            <span className="text-2xl font-bold text-slate-900 dark:text-white">{job.applicantCount}</span>
            {job.newApplicants > 0 && (
      ...
      <div className="flex items-center justify-between mt-4 pt-4 border-t border-slate-100 dark:border-slate-700">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-3 py-1.5 text-sm font-medium text-slate-600 hover:bg-slate-50 dark:hover:bg-slate-700 rounded-lg"
          >
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            <h4 className="font-medium text-slate-900 dark:text-white">{applicant.candidate.name}</h4>
          ...
          {applicant.candidate.headline && (
            <p className="text-sm text-slate-500 mt-0.5">{applicant.candidate.headline}</p>
          )}
        ...
        <div className="relative">
          ...
          {showStatusMenu && (
            <>
              ...
              <div className="absolute right-0 mt-1 w-40 bg-white dark:bg-slate-800 rounded-lg shadow-lg border border-slate-200 dark:border-slate-700 z-20">
  ...
  return (
    <div className="flex items-center gap-4 p-3 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
      <div className="text-center min-w-[50px]">
        ...
        <p className="text-xs text-slate-500">{date.toLocaleString('en-AU', { month: 'short' })}</p>
      </div>
      <div className="flex-1">
      ...
      {activeTab === 'overview' && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            {/* Upcoming Interviews */}
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
              <h3 className="font-semibold text-slate-900 dark:text-white mb-4">Upcoming Interviews</h3>
              <div className="space-y-3">
                {interviews.slice(0, 4).map((interview) => (
                  <InterviewCard key={interview.id} interview={interview} />
                ))}
                {interviews.length === 0 && (
                  <p className="text-center text-slate-500 py-4">No interviews scheduled</p>
                )}
              </div>
            </div>
            ...
            {/* Quick Stats */}
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
              <h3 className="font-semibold text-slate-900 dark:text-white mb-4">Hiring Metrics</h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-slate-500">Avg. Time to Hire</span>
                  <span className="font-medium text-slate-900 dark:text-white">{stats.avgTimeToHire} days</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-500">Applicant-to-Interview</span>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-slate-500">Interview-to-Hire</span>
                  <span className="font-medium text-slate-900 dark:text-white">
        ...
        <div className="space-y-4">
          ...
          {jobs.length === 0 && (
            <div className="text-center py-16 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
              ...
              <h3 className="text-lg font-medium text-slate-900 dark:text-white">No job postings yet</h3>
              <p className="text-slate-500 mt-2">Post your first job to start receiving applications</p>
        ...
        <div>
          ...
          <div className="flex items-center gap-4 mb-6">
            <select
              ...
              className="px-4 py-2 border border-slate-200 dark:border-slate-600 rounded-lg
          ...
          <div className="space-y-4">
            ...
            {applicants.length === 0 && (
              <div className="text-center py-16 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                <div className="text-6xl mb-4">👥</div>
                <h3 className="text-lg font-medium text-slate-900 dark:text-white">No applicants found</h3>
