...
function ModuleCard({
  ...
  return (
    <div className={`relative ${index > 0 ? 'mt-4' : ''}`}>
      {/* Connecting line */}
      {index > 0 && (
        <div className="absolute left-6 -top-4 w-0.5 h-4 bg-slate-200 dark:bg-slate-700" />
      )}
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap items-center gap-3 mt-2 text-xs text-slate-500">
            ...
            {module.provider && (
              <span className="text-slate-400">by {module.provider}</span>
            )}
          </div>
          ...
          {module.skills.length > 0 && (
            <div className="flex flex-wrap gap-1 mt-2">
              ...
              {module.skills.length > 3 && (
                <span className="text-xs text-slate-400">+{module.skills.length - 3} more</span>
              )}
            </div>
          )}
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden hover:shadow-lg transition-shadow">
      ...
      <div className="p-6">
        ...
        <p className="text-slate-500 text-sm mt-2 line-clamp-2">{path.description}</p>
        ...
        <div className="flex flex-wrap gap-1 mt-3">
          ...
          {path.skills.length > 4 && (
            <span className="text-xs text-slate-400">+{path.skills.length - 4}</span>
          )}
        </div>
      </div>
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-xl p-6">
          <h3 className="font-semibold text-slate-900 dark:text-white mb-4">Skills You'll Gain</h3>
            ...
            careerGoals.map((goal) => (
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  <div>
                    <h3 className="text-xl font-semibold text-slate-900 dark:text-white">{goal.title}</h3>
                    ...
                    <div className="space-y-3">
                      {goal.paths.slice(0, 3).map((path) => (
                        <button
                          ...
                          className="w-full flex items-center gap-3 p-3 bg-slate-50 dark:bg-slate-900 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors text-left"
                        >
