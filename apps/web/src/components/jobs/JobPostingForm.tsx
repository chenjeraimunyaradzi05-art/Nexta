    ...
    <div>
      ...
      <div className="space-y-2">
        {items.map((item, index) => (
          <div
            key={index}
            className="flex items-center gap-2 bg-slate-50 dark:bg-slate-700 rounded-lg p-2"
          >
            <span className="flex-1 text-sm text-slate-900 dark:text-white">{item}</span>
            <button
              type="button"
      ...
      <p className="mt-1 text-xs text-slate-500">{items.length}/{maxItems} items</p>
    </div>
  );
}
        ...
        <div className="mt-2 flex flex-wrap gap-1">
          {filteredSuggestions.slice(0, 5).map((skill) => (
            <button
              ...
              className="px-2 py-1 text-xs bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-400 rounded hover:bg-slate-200"
            >
              + {skill}
            </button>
          ))}
...
export function JobPostingForm({
  ...
  return (
    <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2 border rounded-lg bg-white dark:bg-slate-700 
      ...
      {currentStep === 2 && (
        <div className="space-y-6">
          <h2 className="text-lg font-semibold text-slate-900 dark:text-white">Requirements & Responsibilities</h2>
      ...
      {currentStep === 3 && (
        <div className="space-y-6">
          <h2 className="text-lg font-semibold text-slate-900 dark:text-white">Compensation & Benefits</h2>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <label className="flex items-center gap-2 text-sm">
                ...
                />
                <span className="text-slate-600 dark:text-slate-400">Display salary on listing</span>
              </label>
            </div>
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-xs text-slate-500 mb-1">Pay Period</label>
                <select
      ...
      {currentStep === 4 && (
        <div className="space-y-6">
          <h2 className="text-lg font-semibold text-slate-900 dark:text-white">Indigenous Focus & Review</h2>
          ...
          <div className="bg-slate-50 dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-700">
            <h3 className="font-semibold text-slate-900 dark:text-white mb-4">Job Preview</h3>
            
            <div className="space-y-4">
              <div className="flex items-start justify-between">
                <div>
                  <h4 className="text-xl font-bold text-slate-900 dark:text-white">{formData.title || 'Job Title'}</h4>
                  <p className="text-slate-600 dark:text-slate-400">{formData.company || 'Company Name'}</p>
                </div>
              ...
              {formData.skills.length > 0 && (
                <div className="flex flex-wrap gap-1">
                  {formData.skills.map((skill) => (
                    <span key={skill} className="px-2 py-0.5 bg-slate-200 dark:bg-slate-700 text-slate-600 dark:text-slate-400 rounded text-xs">
                      {skill}
                    </span>
                  ))}
                </div>
