        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className={`p-1.5 rounded hover:bg-slate-100 dark:hover:bg-slate-700 ${
              bookmark.note ? 'text-yellow-500' : 'text-slate-400'
            }`}
            aria-label="Add note"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1 space-y-4">
          <h2 className="font-semibold text-slate-900 dark:text-white mb-3">Collections</h2>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-slate-900 dark:text-white">All Bookmarks</span>
            </div>
          </div>
        ...
        <div className="lg:col-span-3">
          ...
          {isLoadingBookmarks ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="mt-4 text-lg font-medium text-slate-900 dark:text-white">No bookmarks yet</h3>
