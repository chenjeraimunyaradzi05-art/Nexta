...
function CategoryCard({
  ...
  return (
    ...
    >
      ...
      <h3 className={`mt-2 font-semibold ${isSelected ? 'text-white' : 'text-slate-900 dark:text-white'}`}>
        {category.name}
      </h3>
    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5 hover:shadow-lg transition-shadow">
      <div className="flex items-start justify-between">
        <div className="flex-1">
          ...
          <h3 className="font-semibold text-slate-900 dark:text-white">{assessment.title}</h3>
          <p className="text-sm text-slate-500 line-clamp-2 mt-1">{assessment.description}</p>
        </div>
        {assessment.badge && (
        ...
        <div className={`mt-4 p-3 rounded-lg ${
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className={`text-sm font-medium ${assessment.userAttempts.passed ? 'text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400'}`}>
...
function QuestionView({
  ...
  return (
    <div>
      ...
      <div className="h-2 bg-slate-100 dark:bg-slate-700 rounded-full mb-6">
        <div 
      ...
      {question.type === 'short-answer' && (
        <textarea
          ...
          rows={4}
          className="w-full px-4 py-3 border border-slate-200 dark:border-slate-600 rounded-lg
...
function ResultView({
  ...
  return (
    <div className="text-center py-8">
      ...
      {result.badge && (
        <div className="mt-6">
          <p className="text-sm text-slate-500 mb-2">You earned a badge!</p>
      ...
      <div className="grid grid-cols-3 gap-4 mt-8 max-w-md mx-auto">
        <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-lg">
          <p className="text-2xl font-bold text-slate-900 dark:text-white">{result.earnedPoints}</p>
      ...
      <div className="mt-8 max-w-md mx-auto">
        <h4 className="text-sm font-medium text-slate-700 dark:text-slate-300 mb-3">Question Breakdown</h4>
...
export function SkillsAssessment() {
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {timeRemaining !== null && (
            <div className={`px-4 py-2 rounded-lg font-mono font-medium ${
              timeRemaining < 60 ? 'bg-red-100 text-red-700' : 'bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-white'
            }`}>
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Skills Assessment</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-4 mb-8">
        ...
        >
          ...
          <h3 className={`mt-2 font-semibold ${!selectedCategory ? 'text-white' : 'text-slate-900 dark:text-white'}`}>
            All
          </h3>
          <p className={`text-sm mt-1 ${!selectedCategory ? 'text-blue-100' : 'text-slate-500'}`}>
