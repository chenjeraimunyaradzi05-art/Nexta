...
export const metadata = {
  ...
  description:
    'Find Indigenous employment opportunities across Australia. Browse jobs from leading employers committed to First Nations careers, traineeships, and culturally safe workplaces.',
  keywords: [
    'Indigenous jobs',
  ...
  openGraph: {
    ...
    description:
      'Find Indigenous employment opportunities across Australia from leading employers.',
    url: '/jobs',
  },
  alternates: {
    canonical: '/jobs',
...
export default async function JobsPage() {
  ...
  try {
    // In production, use the app's own origin for the Neon API route.
    // In dev, Next.js server components can fetch their own API routes via absolute URL.
    const origin =
      process.env.URL ||
    ...
    const res = await fetch(`${origin}/api/neon/jobs?page=1&pageSize=10`, {
      cache: 'no-store',
    });
