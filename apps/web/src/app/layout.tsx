...
export default function RootLayout({ children }: { children: ReactNode }) {
  ...
  return (
    ...
    >
      ...
      <body className="min-h-screen flex flex-col bg-gradient-to-br from-white via-teal-50/30 to-purple-50/20 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950/60 cosmic:bg-cosmic-dark text-slate-900 dark:text-slate-50 cosmic:text-slate-50 transition-colors duration-200">
