    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 py-12 px-4">
        <div className="max-w-lg mx-auto text-center">
          ...
          <p className="text-slate-600 mb-6">You need to be signed in to start an audio room.</p>
          <Link
            href="/"
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Start an Audio Room</h1>
            <p className="text-slate-600">Host a conversation with your community</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h2 className="text-lg font-semibold text-slate-900 mb-4">Room Details</h2>
                ...
                {suggestedTopics
                  ...
                  .map((topic, idx) => (
                    <button
                      ...
                      className="px-3 py-1.5 bg-slate-100 text-slate-700 rounded-full text-sm hover:bg-slate-200 disabled:opacity-50 transition-colors"
                    >
                      + {topic}
                    </button>
                  ))}
          ...
          {/* Room Settings */}
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h2 className="text-lg font-semibold text-slate-900 mb-4">Room Settings</h2>
            ...
            <div className="space-y-4">
              ...
              <label className="flex items-center justify-between">
                <div>
                  <span className="font-medium text-slate-900">Hand Raise</span>
                  <p className="text-sm text-slate-500">Allow listeners to request to speak</p>
                </div>
                <input
                  type="checkbox"
                  name="allowHandRaise"
              ...
              <label className="flex items-center justify-between">
                <div>
                  <span className="font-medium text-slate-900">Record Room</span>
                  <p className="text-sm text-slate-500">Save a recording for later (speakers will be notified)</p>
                </div>
                <input
                  type="checkbox"
                  name="recordRoom"
