    ...
    <div className="min-h-screen bg-slate-50 py-8">
      <div className="max-w-2xl mx-auto px-4">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold text-slate-900">Edit SSO Configuration</h1>
          <Link
            href="/dashboard/company/integrations"
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                <div className="text-xs text-slate-500">OAuth 2.0 based</div>
              </button>
            </div>
          </div>
          ...
          <div className="border-t pt-6">
            <h4 className="font-medium text-slate-900 mb-4">Provisioning Options</h4>
