      ...
      <div className="max-w-lg w-full text-center">
        ...
        <div className="space-y-4">
          <Link
            ...
            className="block w-full p-4 bg-white dark:bg-slate-800 rounded-lg shadow hover:shadow-lg transition-shadow border border-slate-200 dark:border-slate-700"
          >
