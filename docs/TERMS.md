...
- **"Candidate"**: Users seeking employment opportunities
- **"Employer"**: Organizations posting job opportunities
- **"Mentor"**: Users providing mentorship services
- **"Content"**: Text, images, videos, or other materials uploaded to the Platform
...
Employers must be legally registered businesses authorized to recruit employees.
...
- Any losses from unauthorized use
...
- Provide accurate information in profiles and applications
...
You retain ownership of Content you submit. By uploading Content, you grant us a non-exclusive, worldwide, royalty-free license to:

- Display Content on the Platform
- Share Content with potential employers (for Candidates)
- Use Content to improve our services
- Create derivative works (e.g., anonymized statistics)

### 6.2 Content Standards

Content must not:
- Be illegal, harmful, or offensive
- Violate third-party rights
- Contain personal data of others without consent
- Include discriminatory material
...
- Suspend accounts for Content violations
...
Basic features are available at no cost to Candidates.
...
You may not:
- Copy, modify, or distribute Platform elements
...
Your use of the Service is subject to our [Privacy Policy](/privacy). By using the Service, you consent to our data practices as described.

## 11. Third-Party Services

The Platform integrates with third-party services (e.g., Stripe, video conferencing). These services have their own terms and privacy policies. We are not responsible for third-party services.

## 12. Disclaimers

### 12.1 Service Provided "As Is"

The Platform is provided without warranties of any kind. We do not guarantee:

- Uninterrupted or error-free service
- Accuracy or completeness of Content
- Results from using the Service
- Employment outcomes for Candidates
- Quality of applicants for Employers

### 12.2 No Employment Guarantee

We do not guarantee:
- Candidates will find employment
- Employers will find suitable candidates
- Specific outcomes from mentorship
...
- We are not liable for data loss from circumstances beyond our control
...
4. **Litigation**: For matters not subject to arbitration, courts of New South Wales have jurisdiction
...
- These Terms survive as applicable
...
*These Terms are effective as of [Effective Date] and supersede all prior terms.*
